    ...
    <a-spin :spinning="loading">
      <a-form-model ref="form" :model="form" :rules="rules" :label-col="{span:5}" :wrapper-col="{span:14}">
        ...
        <a-form-model-item label="API 格式" prop="apiFormat">
          <a-select v-model="form.apiFormat">
