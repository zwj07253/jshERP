<template>
  <j-modal
    ...
    <template slot="footer">
      ...
      <a-button v-if="billPrintFlag && isShowPrintBtn" @click="handlePrintPro('拆卸单')">{{ $t('common.printNew') }}</a-button>
      <a-button v-if="billPrintFlag && isShowPrintBtn" @click="handlePrint('拆卸单')">{{ $t('common.print') }}</a-button>
