        ...
        <div class="table-page-search-wrapper">
          <a-form layout="inline" @keyup.enter.native="searchQuery">
            <a-row :gutter="24">
              ...
              <a-col :md="4" :sm="24">
                <a-form-item>
                  <span style="white-space: nowrap;">{{ $t('report.actualSalesAmount') }}：{{realityPriceTotal}}</span>
                </a-form-item>
              </a-col>
            </a-row>
          ...
          <a-row :gutter="24" style="margin-top: 8px;text-align:right;">
            <a-col :md="24" :sm="24">
              <a-pagination @change="paginationChange" @showSizeChange="paginationShowSizeChange"
                ...
                :show-total="total => $t('common.paginationTotal', { total: total })">
  ...
  export default {
    ...
    data () {
      return {
        ...
        defColumns: [
          ...
          {title: this.$t('report.salesQty'), dataIndex: 'outSum', sorter: (a, b) => a.outSum - b.outSum, width: 80},
          {title: this.$t('report.salesAmount'), dataIndex: 'outSumPrice', sorter: (a, b) => a.outSumPrice - b.outSumPrice, width: 80},
          ...
          {title: this.$t('report.actualSalesAmount'), dataIndex: 'outInSumPrice', sorter: (a, b) => a.outInSumPrice - b.outInSumPrice, width: 100}
        ],
        url: {
    ...
    computed: {
      displayDataSource() {
        ...
        const totalRow = {
          id: `sale-total-${this.ipagination.current}`,
    ...
    methods: {
      ...
      exportExcelRows(dataSource) {
        ...
        let head = this.$t('report.colBarCode') + ',' + this.$t('report.colName') + ',' + this.$t('report.colSpec') + ',' + this.$t('report.colModel') + ',' + this.$t('report.colColor') + ',' + this.$t('report.colBrand') + ',' + this.$t('report.colManufacturer') + ',' + mpStr + ',' + this.$t('report.colUnit') + ',' + this.$t('report.colSalesQty') + ',' + this.$t('report.colSalesAmount') + ',' + this.$t('report.colReturnQty') + ',' + this.$t('report.colReturnAmount') + ',' + this.$t('report.colActualSalesAmount')
        ...
        this.handleExportXlsPost(this.$t('report.salesStats'), this.$t('report.salesStats'), head, tip, list)
      }
    }
  }
</script>
