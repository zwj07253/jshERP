      ...
      <a-spin :spinning="confirmLoading">
        <a-form :form="form" id="vendorModal">
          ...
          <a-row class="form-row" :gutter="24">
            ...
            <a-col :span="24/2">
              <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" :label="$t('system.beginNeedPayLabel')">
                <a-input-number style="width:100%" :min="0" :precision="2" :placeholder="$t('system.enterBeginNeedPay')" v-decorator="[ 'beginNeedPay' ]" />
              </a-form-item>
            </a-col>
            <a-col :span="24/2">
              <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" :label="$t('system.allNeedPayLabel')">
