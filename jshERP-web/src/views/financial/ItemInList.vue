    ...
    <a-col :md="24">
      <a-card :style="cardStyle" :bordered="false">
          ...
          <a-form layout="inline" @keyup.enter.native="searchQuery">
            ...
            <template v-if="toggleSearchStatus">
              <a-row :gutter="24">
                ...
                <a-col :md="6" :sm="24">
                  <a-form-item :label="$t('financial.form.incomeAccount')" :labelCol="labelCol" :wrapperCol="wrapperCol">
                    <a-select :placeholder="$t('financial.form.selectIncomeAccount')" showSearch allow-clear optionFilterProp="children" v-model="queryParam.accountId">
                ...
                <a-col :md="6" :sm="24">
                  <a-form-item :label="$t('financial.form.incomeItem')" :labelCol="labelCol" :wrapperCol="wrapperCol">
                    <a-select :placeholder="$t('financial.form.selectIncomeItem')" showSearch allow-clear optionFilterProp="children" v-model="queryParam.inOutItemId">
        ...
        <div class="table-operator"  style="margin-top: 5px">
          ...
          <a-tooltip placement="left" :title="$t('financial.incomeTip')" slot="action">
        ...
        <div>
          <a-table
            ...
            <span slot="action" slot-scope="text, record">
              <a @click="myHandleDetail(record, '收入', prefixNo)">{{ $t('common.view') }}</a>
    ...
    data () {
      return {
        ...
        columns: [
          ...
          { title: this.$t('financial.form.incomeAccount'), dataIndex: 'accountName',width:100, ellipsis:true},
          { title: this.$t('financial.form.incomeAmount'), dataIndex: 'changeAmount',width:80},
