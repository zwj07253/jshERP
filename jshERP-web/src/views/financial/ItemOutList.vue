    ...
    <a-col :md="24">
      <a-card :style="cardStyle" :bordered="false">
          ...
          <a-form layout="inline" @keyup.enter.native="searchQuery">
            <a-row :gutter="24">
              ...
              <a-col :md="6" :sm="24">
                <a-form-item :label="$t('common.supplier')" :labelCol="labelCol" :wrapperCol="wrapperCol">
                  <a-select :placeholder="$t('common.selectSupplier')" showSearch allow-clear optionFilterProp="children" v-model="queryParam.organId" @search="handleSearchOrgan">
                    <div slot="dropdownRender" slot-scope="menu">
                      <v-nodes :vnodes="menu" />
                      <a-divider style="margin: 4px 0;" />
                      <div class="dropdown-btn" @mousedown="e => e.preventDefault()" @click="initOrgan(0)"><a-icon type="reload" /> {{ $t('common.refreshList') }}</div>
                    </div>
            ...
            <template v-if="toggleSearchStatus">
              <a-row :gutter="24">
                ...
                <a-col :md="6" :sm="24">
                  <a-form-item :label="$t('financial.form.expenseAccount')" :labelCol="labelCol" :wrapperCol="wrapperCol">
                    <a-select :placeholder="$t('financial.form.selectExpenseAccount')" showSearch allow-clear optionFilterProp="children" v-model="queryParam.accountId">
                ...
                <a-col :md="6" :sm="24">
                  <a-form-item :label="$t('financial.form.expenseItem')" :labelCol="labelCol" :wrapperCol="wrapperCol">
                    <a-select :placeholder="$t('financial.form.selectExpenseItem')" showSearch allow-clear optionFilterProp="children" v-model="queryParam.inOutItemId">
        ...
        <div class="table-operator"  style="margin-top: 5px">
          ...
          <a-tooltip placement="left" :title="$t('financial.expenseTip')" slot="action">
        ...
        <div>
          <a-table
            ...
            <span slot="action" slot-scope="text, record">
              <a @click="myHandleDetail(record, '支出', prefixNo)">{{ $t('common.view') }}</a>
    ...
    data () {
      return {
        ...
        columns: [
          ...
          { title: this.$t('common.supplier'), dataIndex: 'organName',width:140, ellipsis:true},
          ...
          { title: this.$t('financial.form.expenseAccount'), dataIndex: 'accountName',width:100, ellipsis:true},
          { title: this.$t('financial.form.expenseAmount'), dataIndex: 'changeAmount',width:80},
