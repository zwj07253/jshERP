    ...
    <a-col :md="24">
      <a-card :style="cardStyle" :bordered="false">
          ...
          <a-form layout="inline" @keyup.enter.native="searchQuery">
            ...
            <template v-if="toggleSearchStatus">
              <a-row :gutter="24">
                ...
                <a-col :md="6" :sm="24">
                  <a-form-item :label="$t('purchase.form.settlementAccount')" :labelCol="labelCol" :wrapperCol="wrapperCol">
                ...
                <a-col :md="6" :sm="24">
                  <a-form-item :label="$t('common.billStatus')" :labelCol="labelCol" :wrapperCol="wrapperCol">
                    ...
                    <a-select-option value="3">{{ $t('purchase.partialOutbound') }}</a-select-option>
                    <a-select-option value="2">{{ $t('purchase.completedOutbound') }}</a-select-option>
                    </a-select>
                  </a-form-item>
                </a-col>
                <a-col :md="6" :sm="24">
        ...
        <div class="table-operator"  style="margin-top: 5px">
          ...
          <a-tooltip :title="$t('purchase.forceCloseOutboundTip')">
            <a-button v-if="inOutManageFlag && btnEnableList.indexOf(1)>-1" icon="issues-close" @click="batchForceClose">{{ $t('purchase.forceClose') }}</a-button>
          </a-tooltip>
          ...
          <a-tooltip placement="left" :title="$t('purchase.returnTip')" slot="action">
        ...
        <div>
          <a-table
            ...
            <span slot="action" slot-scope="text, record">
              <a @click="myHandleDetail(record, '采购退货出库', prefixNo)">{{ $t('retail.view') }}</a>
            ...
            <template slot="customRenderStatus" slot-scope="status">
              ...
              <a-tag v-if="status == '2'" color="cyan">{{ $t('purchase.completedOutbound') }}</a-tag>
              <a-tag v-if="status == '3'" color="blue">{{ $t('purchase.partialOutbound') }}</a-tag>
    ...
    data () {
      return {
        ...
        defColumns: [
          ...
          { title: this.$t('purchase.form.debt'), dataIndex: 'debt',width:80},
