    ...
    <a-col :md="24">
      <a-card :style="cardStyle" :bordered="false">
        ...
        <div class="table-operator"  style="margin-top: 5px">
          ...
          <a-tooltip placement="left" :title="$t('common.otherInTip')" slot="action">
        ...
        <div>
          <a-table
            ...
            <span slot="action" slot-scope="text, record">
              <a @click="myHandleDetail(record, '其它入库', prefixNo)">{{ $t('common.view') }}</a>
    ...
    data () {
      return {
        ...
        defColumns: [
          ...
          { title: this.$t('common.supplier'), dataIndex: 'organName',width:120, ellipsis:true},
