        ...
        <a-row class="form-row" :gutter="24">
          <a-col :lg="6" :md="12" :sm="24">
            <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" :label="$t('financial.form.payingMember')">
              <a-select :placeholder="$t('financial.form.selectPayingMember')" v-decorator="[ 'organId', validatorRules.organId ]"
        ...
        <a-row class="form-row" :gutter="24">
          ...
          <a-col :lg="6" :md="12" :sm="24">
            <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" :label="$t('financial.form.receiptAmount')">
              <a-input :placeholder="$t('retail.getAmountPlaceholder')" v-decorator.trim="[ 'changeAmount' ]" :readOnly="true"/>
            </a-form-item>
          </a-col>
          <a-col :lg="6" :md="12" :sm="24">
          </a-col>
    ...
    data () {
      return {
          ...
          columns: [
            ...
            { title: this.$t('financial.form.amount'),key: 'eachAmount', width: '10%', type: FormTypes.inputNumber, statistics: true, placeholder: this.$t('common.pleaseSelect') + '${title}',
              validateRules: [
                ...
                { handler: (type, value, row, column, callback) => callback(Number(value) > 0), message: this.$t('financial.validation.fieldMustBePositive') }
              ]
            },
        ...
        validatorRules:{
          organId:{
            rules: [
              { required: true, message: this.$t('financial.form.selectPayingMemberValidation') }
            ]
          },
          billTime:{
            rules: [
