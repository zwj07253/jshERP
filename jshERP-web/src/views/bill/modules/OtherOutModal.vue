<template>
  <j-modal
    ...
    <template slot="footer">
      ...
      <a-button v-if="billPrintFlag && isShowPrintBtn" @click="handlePrintPro('其它出库')">{{ $t('common.printNew') }}</a-button>
      <a-button v-if="billPrintFlag && isShowPrintBtn" @click="handlePrint('其它出库')">{{ $t('common.print') }}</a-button>
      ...
      <a-form :form="form">
        <a-row class="form-row" :gutter="24">
          <a-col :lg="6" :md="12" :sm="24">
            <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" :label="$t('common.customer')">
              <a-select :placeholder="$t('common.selectCustomer')" v-decorator="[ 'organId' ]" :disabled="!rowCanEdit"
          ...
          <a-col :lg="6" :md="12" :sm="24">
            <a-form-item v-if="inOutManageFlag && !model.billType" :labelCol="labelCol" :wrapperCol="wrapperCol" :label="$t('common.linkedBill')">
              <a-input-search :placeholder="$t('common.selectPendingOutboundBill')" v-decorator="[ 'linkNumber' ]" @search="onSearchLinkNumber" :readOnly="true"/>
            </a-form-item>
          </a-col>
        </a-row>
        <j-editable-table id="billModal"
          ...
          <template #buttonAfter>
            <a-row v-if="rowCanEdit" :gutter="24" style="float:left;" data-step="4" :data-title="$t('common.scanEntry')" :data-intro="$t('common.scanEntry')">
      ...
      return {
        ...
        materialTable: {
          ...
          columns: [
            ...
            { title: this.$t('purchase.finishInbound'), key: 'finishNumber', width: '4%', type: FormTypes.normal },
