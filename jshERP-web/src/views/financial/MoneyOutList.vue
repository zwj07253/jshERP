    ...
    <a-col :md="24">
      <a-card :style="cardStyle" :bordered="false">
            ...
            <a-row :gutter="24">
              ...
              <a-col :md="6" :sm="24">
                <a-form-item :label="$t('common.supplier')" :labelCol="labelCol" :wrapperCol="wrapperCol">
                  <a-select :placeholder="$t('common.selectSupplier')" showSearch allow-clear optionFilterProp="children" v-model="queryParam.organId" @search="handleSearchSupplier">
                    <div slot="dropdownRender" slot-scope="menu">
                      <v-nodes :vnodes="menu" />
                      <a-divider style="margin: 4px 0;" />
                      <div class="dropdown-btn" @mousedown="e => e.preventDefault()" @click="initSupplier(0)"><a-icon type="reload" /> {{ $t('common.refreshList') }}</div>
                    </div>
        ...
        <div class="table-operator"  style="margin-top: 5px">
          ...
          <a-button v-if="btnEnableList.indexOf(1)>-1" @click="myHandleAddWithOrgan" icon="link">{{ $t('financial.payment') }}({{waitTotal}})</a-button>
          ...
          <a-tooltip placement="left" :title="$t('financial.paymentTip')" slot="action">
        ...
        <div>
          <a-table
            ...
            <span slot="action" slot-scope="text, record">
              <a @click="myHandleDetail(record, $t('financial.payment'), prefixNo)">{{ $t('common.view') }}</a>
    ...
    data () {
      return {
        ...
        columns: [
          ...
          { title: this.$t('financial.totalPayment'), dataIndex: 'totalPrice',width:80},
          { title: this.$t('financial.discountAmount'), dataIndex: 'discountMoney',width:80},
          { title: this.$t('financial.actualPayment'), dataIndex: 'changeAmount',width:80},
