    ...
    <a-col :md="24">
      <a-card :style="cardStyle" :bordered="false">
        ...
        <div class="table-operator"  style="margin-top: 5px">
          ...
          <a-button v-if="btnEnableList.indexOf(3)>-1" @click="handleExportXls($t('system.customerInfo'))" icon="download">{{ $t('common.export') }}</a-button>
        </div>
        <!-- table区域-begin -->
        <div>
          <a-table
            ...
            <span slot="action" slot-scope="text, record">
              <a v-if="btnEnableList.indexOf(1)>-1 && customerFlag === '1' && quickBtn.user.indexOf(1)>-1 " @click="btnSetUser(record)">{{ $t('common.assignUser') }}</a>
  ...
  export default {
    ...
    data () {
      return {
        ...
        columns: [
          ...
          { title: this.$t('system.beginNeedGet'),dataIndex: 'beginNeedGet',width:80,align:"left"},
          { title: this.$t('system.allNeedGet'),dataIndex: 'allNeedGet',width:80,align:"left"},
    ...
    methods: {
      ...
      handleImportXls() {
        ...
        let templateName = this.$t('common.customerExcelTemplate')
        this.$refs.modalImportForm.initModal(importExcelUrl, templateUrl, templateName);
        this.$refs.modalImportForm.title = this.$t('common.customerImport');
      },
      ...
      btnSetUser(record) {
        ...
        this.$refs.customerUserModal.title = this.$t('common.assignUserTo') + record.supplier
